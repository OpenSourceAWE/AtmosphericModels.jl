# -*- coding: utf-8 -*-
"""
This module provides the class WindField that provides methods to create a turbulent
wind field and to read the actual wind velocity vector as function of the 3d position
...
# TODO: add interpolation in y-direction to the method getWind
# TODO: plot turbulence intensity in colors (2D)
...
if PAPER:
    ...
    #mpl.rcParams['text.latex.preamble'].append(r'\DeclareMathSizes{14}{14}{14}{14}')
...
def calcWindHeight(v_wind_gnd, height, ref_height = REF_HEIGHT):
    """ Calculate the wind speed at a given height and reference height. """
    z, z_ref = height, ref_height
    return (v_wind_gnd * (z / z_ref)**ALPHA)
...
def calc_full_name(v_wind_gnd, basename='windfield_4050_500', rel_sigma = 1.0):
